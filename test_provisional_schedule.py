...
check("context_version 22 (snapshot i kod neuspjele analize; v22 26.09.2026 20:28)", '"context_version": 22' in _pr)
...
check("context_version 22", '"context_version": 22' in _prv)
